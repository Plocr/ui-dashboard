...
return {
  ...
  apply(ctx) {
    ...
    // 右栏主体：仪表盘
    function DashboardPanel({ useSessions, useSession, useWorkspaces, sessionId, useProjection, t, closeDetails }) {
      ...
      return React.createElement('div', { className: 'udash-root' }, [
